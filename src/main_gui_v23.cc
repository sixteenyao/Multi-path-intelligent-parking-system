...
int main(){
    ...
    masks[2]={{{481,128},{798,168},{1264,1079},{647,1079}},{{714,0},{1046,246},{1265,305},{1681,561},{1714,424},{920,0}}}; // C双蒙版
    ...
    while(1){
        ...
        if(state==MAIN){
            ...
            if(!parking_masks[cam].empty())draw_all_polys(drm,bk,parking_masks[cam],mk(255,0,255));
            // 返回按钮 — 文字居中
